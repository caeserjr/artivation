...
const getArtPieces = async () => {
  console.log(
    "🚀 ~ file: artPieceModel.js ~ line 83 ~ getArtPieces ~ getArtPieces"
  );
...
const postArtPiece = async (payload) => {
  console.log(
    "🚀 ~ file: messageModel.js ~ line 318 ~ postedMessage ~ payload",
    payload
  );
  try {
    if (true) {
...
const checkLikeStatus = async ({ pieceId }) => {
  console.log(
    "🚀 ~ file: artPieceModel.js ~ line 125 ~ checkLikeStatus ~ pieceId",
    pieceId
  );
  try {
    if (
